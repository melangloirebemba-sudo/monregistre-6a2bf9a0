...
function FloatingAdd({ onClick }: { onClick: () => void }) {
  return (
    <button
      onClick={onClick}
      aria-label="Ajouter"
      className="fixed bottom-24 right-1/2 z-20 grid h-14 w-14 translate-x-[195px] place-items-center rounded-full bg-teal text-teal-foreground shadow-[var(--shadow-hero)] transition-transform hover:scale-105 md:translate-x-[240px] lg:translate-x-[280px]"
    >
